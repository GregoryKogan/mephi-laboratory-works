...
TEST(array_constructor, array_sequence_suite) {
  int *values = new int[10];
  for (int i = 0; i < 10; ++i)
    values[i] = i + 1;

  kogan::ArraySequence<int> seq(values, 10);
  delete[] values;
...
TEST(empty_constructor, array_sequence_suite) {
  kogan::ArraySequence<int> seq;

  ASSERT(seq.get_length() == 0);
}

TEST(sequence_constructor, array_sequence_suite) {
  int *values = new int[10];
  for (int i = 0; i < 10; ++i)
    values[i] = i + 1;

  kogan::ArraySequence<int> init_seq(values, 10);
  kogan::ArraySequence<int> seq(init_seq);
  delete[] values;
...
TEST(get_first, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(get_first_single_item, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  seq.append(1);
...
TEST(get_last, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(get_last_single_item, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  seq.append(1);
...
TEST(get_single_item, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  seq.append(1);
...
TEST(get_negative_index_IndexOutOfRangeException, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(get_big_index_IndexOutOfRangeException, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(get_subsequence, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(get_subsequence_max_bounds, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(get_subsequence_InvalidArgumentException, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(get_subsequence_big_index_IndexOutOfRangeException, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(get_length, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
  ...
  kogan::ArraySequence<int> seq_empty;
  ASSERT(seq_empty.get_length() == 0);
}

TEST(set, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(set_negative_index_IndexOutOfRangeException, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(set_big_index_IndexOutOfRangeException, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(append, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(prepend, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.prepend(i + 1);
...
TEST(insert, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(insert_negative_index_IndexOutOfRangeException, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(insert_big_index_IndexOutOfRangeException, array_sequence_suite) {
  kogan::ArraySequence<int> seq;
  for (int i = 0; i < 10; ++i)
    seq.append(i + 1);
...
TEST(concat, array_sequence_suite) {
  kogan::ArraySequence<int> seq1;
  kogan::ArraySequence<int> seq2;
  for (int i = 0; i < 10; ++i) {
    seq1.append(i + 1);
    seq2.append(i + 11);
  }
...
TEST(concat_empty_tail, array_sequence_suite) {
  kogan::ArraySequence<int> seq1;
  kogan::ArraySequence<int> seq2;
  for (int i = 0; i < 10; ++i) {
    seq1.append(i + 1);
...
TEST(concat_empty_head, array_sequence_suite) {
  kogan::ArraySequence<int> seq1;
  kogan::ArraySequence<int> seq2;
  for (int i = 0; i < 10; ++i) {
    seq1.append(i + 1);
...
kogan::TestSuite get_array_sequence_suite() { return array_sequence_suite; }
