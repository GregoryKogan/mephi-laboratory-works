...
void size_menu(kogan::NaryTree<char>* tree) {
    log_blue("Get size"); std::cout << std::endl;
...
void children_count_menu(kogan::NaryTree<char>* tree) {
    log_blue("Count children"); std::cout << std::endl;
...
void height_menu(kogan::NaryTree<char>* tree) {
    log_blue("Get height"); std::cout << std::endl;
...
void set_menu(kogan::NaryTree<char>* tree) {
    log_blue("Set value"); std::cout << std::endl;
...
void add_child_menu(kogan::NaryTree<char>* tree) {
    log_blue("Add child"); std::cout << std::endl;
...
void remove_child_menu(kogan::NaryTree<char>* tree) {
    log_blue("Remove child"); std::cout << std::endl;
...
void get_child_menu(kogan::NaryTree<char>* tree) {
    log_blue("Get child"); std::cout << std::endl;
...
void traverse_menu(kogan::NaryTree<char>* tree) {
    log_blue("Traverse"); std::cout << std::endl;

    kogan::Sequence<char>* NLR = tree->traverse(kogan::NaryTree<char>::TraverseType::ROOT_LEFT_RIGHT);
    kogan::Sequence<char>* NRL = tree->traverse(kogan::NaryTree<char>::TraverseType::ROOT_RIGHT_LEFT);
    kogan::Sequence<char>* LRN = tree->traverse(kogan::NaryTree<char>::TraverseType::LEFT_RIGHT_ROOT);
    kogan::Sequence<char>* RLN = tree->traverse(kogan::NaryTree<char>::TraverseType::RIGHT_LEFT_ROOT);
...
void count_menu(kogan::NaryTree<char>* tree) {
    log_blue("Count"); std::cout << std::endl;
