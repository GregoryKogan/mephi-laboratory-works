...
action select_action_menu(kogan::ArraySequence<int> *array_seq,
...
kogan::Sequence<int> *
select_sequence_menu(kogan::ArraySequence<int> *array_seq,
                     kogan::LinkedListSequence<int> *linked_list_seq,
                     int *selected_type = nullptr) {
  log_blue("Select sequence: ");
  std::cout << std::endl;
...
void input_menu(kogan::ArraySequence<int> *array_seq,
                kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Input sequence");
  std::cout << std::endl;
...
void set_menu(kogan::ArraySequence<int> *array_seq,
              kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Set sequence's value");
  std::cout << std::endl;
  kogan::Sequence<int> *seq = select_sequence_menu(array_seq, linked_list_seq);
...
void append_menu(kogan::ArraySequence<int> *array_seq,
                 kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Append value");
  std::cout << std::endl;
  kogan::Sequence<int> *seq = select_sequence_menu(array_seq, linked_list_seq);
...
void prepend_menu(kogan::ArraySequence<int> *array_seq,
                  kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Prepend value");
  std::cout << std::endl;
  kogan::Sequence<int> *seq = select_sequence_menu(array_seq, linked_list_seq);
...
void insert_menu(kogan::ArraySequence<int> *array_seq,
                 kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Insert value");
  std::cout << std::endl;
  kogan::Sequence<int> *seq = select_sequence_menu(array_seq, linked_list_seq);
...
void concatenate_menu(kogan::ArraySequence<int> *array_seq,
                      kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Concatenate sequences");
  std::cout << std::endl;
  int selected_type;
  kogan::Sequence<int> *seq =
      select_sequence_menu(array_seq, linked_list_seq, &selected_type);
...
void subsequence_menu(kogan::ArraySequence<int> *array_seq,
                      kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Get subsequence");
  std::cout << std::endl;
  kogan::Sequence<int> *seq = select_sequence_menu(array_seq, linked_list_seq);
...
void remove_menu(kogan::ArraySequence<int> *array_seq,
                 kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Remove value");
  std::cout << std::endl;
  kogan::Sequence<int> *seq = select_sequence_menu(array_seq, linked_list_seq);
...
void clear_menu(kogan::ArraySequence<int> *array_seq,
                kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Clear sequence");
  std::cout << std::endl;
  kogan::Sequence<int> *seq = select_sequence_menu(array_seq, linked_list_seq);
...
void length_menu(kogan::ArraySequence<int> *array_seq,
                 kogan::LinkedListSequence<int> *linked_list_seq) {
  log_blue("Get length");
  std::cout << std::endl;
  kogan::Sequence<int> *seq = select_sequence_menu(array_seq, linked_list_seq);
