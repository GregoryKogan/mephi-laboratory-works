...
template <class T> ArraySequence<T>::ArraySequence(T *items, int count) {
  array = new DynamicArray<T>(items, count);
}

template <class T> ArraySequence<T>::ArraySequence() {
...
template <class T> ArraySequence<T>::~ArraySequence() { delete array; }

template <class T> T ArraySequence<T>::get_first() const { return get(0); }

template <class T> T ArraySequence<T>::get_last() const {
...
template <class T>
Sequence<T> *ArraySequence<T>::get_subsequence(int start_index,
                                               int end_index) const {
...
template <class T> size_t ArraySequence<T>::get_length() const {
  return array->get_length();
}

template <class T> void ArraySequence<T>::set(int index, T item) {
  array->set(index, item);
}

template <class T> void ArraySequence<T>::append(T item) {
  array->resize(get_length() + 1);
  set(get_length() - 1, item);
}

template <class T> void ArraySequence<T>::prepend(T item) {
  array->resize(get_length() + 1);
...
template <class T> void ArraySequence<T>::insert(int index, T item) {
...
template <class T> void ArraySequence<T>::clear() { array->resize(0); }

template <class T> void ArraySequence<T>::remove(int index) {
  if (index < 0 || index >= get_length())
