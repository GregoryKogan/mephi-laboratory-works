...
Person::Person(struct PersonID id, std::string first_name,
...
PersonID Person::get_id() const { return id; }

[[maybe_unused]] std::string Person::get_first_name() const {
  return first_name;
}

std::string Person::get_middle_name() const { return middle_name; }
